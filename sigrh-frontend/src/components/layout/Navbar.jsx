  ...
  return (
    <header className="sticky top-0 z-30 w-full border-b border-slate-200/80 bg-white/95 px-4 py-3 shadow-sm backdrop-blur sm:px-6">
      ...
      {showLogoutModal && (
        ...
        >
          <div
            className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-slate-950/20"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
              <h3 className="text-base font-bold text-slate-950">Déconnexion</h3>
              <button
                type="button"
                onClick={() => setShowLogoutModal(false)}
            ...
            <div className="space-y-5 p-5">
              ...
              <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                ...
                >
                  <LogOut size={15} strokeWidth={1.9} className="mr-2" />
                  Se déconnecter
                </button>
              </div>
            </div>
